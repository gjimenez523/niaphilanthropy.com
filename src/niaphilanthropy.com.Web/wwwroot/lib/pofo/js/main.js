...
$(document).ready(function () {
    ...
    $('#contact-us-button').on("click", function () {
        ...
        if (error) {
            var dataAttrib = {"Base.SendGrid.DefaultEmailAddress":"gabe@soonie.net", "Base.SendGrid.ApiKey":"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", "Base.SendGrid.Username":"azure_89c728e3c4c160eec647f9c0ab41fba3@azure.com", "Base.SendGrid.Password":"Heroes08", "Base.SendGrid.IsActive":"true"};
            var data = {to:"gabe.jimenez@outlook.com",from:"register@niaphilanthropy.com",message:"The following user is showing interest in NIA Philanthropy: " + $('#email').val() , subject:"Client Registration - NIA Philanthropy",notificationType:"Email",notificationChannel:"Email",notificationAttrib:dataAttrib};
            console.log(data);

            //Get ConnectionAide Categories
            return $.ajax({
                url: 'https://soonie-web.azurewebsites.net/api/services/app/notification/SendEmailNotification',
                type: 'POST',
                data: JSON.stringify(data),
                dataType: 'json',
                contentType: 'application/json; charset=utf-8',
                success: function (content) {
                    $('#niaRegistration')[0].style.display='none'; 
                    $('#niaRegistrationComplete')[0].style.display='block';
                    console.log(content.result);
                    var result = content.result;
                    

                    var dataAttrib = {"Base.SendGrid.DefaultEmailAddress":"gabe@soonie.net", "Base.SendGrid.ApiKey":"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", "Base.SendGrid.Username":"azure_89c728e3c4c160eec647f9c0ab41fba3@azure.com", "Base.SendGrid.Password":"Heroes08", "Base.SendGrid.IsActive":"true"};
                    var data = {to:"marcie@niaphilanthropy.com",from:"register@niaphilanthropy.com",message:"The following user is showing interest in NIA Philanthropy: " + $('#email').val() , subject:"Client Registration - NIA Philanthropy",notificationType:"Email",notificationChannel:"Email",notificationAttrib:dataAttrib};
                    console.log(data);
